    ...
    return(
        ...
        <div className="h-[80vh] mt-24 lg:px-16 lg:py-16 bg-base flex">
                    <div className="bg-white mt-10 w-full lg:w-1/2 m-auto p-8">
                        ...
                        <div className="relative my-5 w-full lg:w-2/3 mx-auto">
                            <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" className="bg-primary text-lg font-semibold text-slate-100 text-center hover:shadow-lg rounded-lg w-full py-2 transition duration-500">Kirim</button>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative w-full max-w-md max-h-full">
                    <div className="relative bg-white rounded-lg shadow">
                        ...
                        <div className="p-6 text-center">
                            ...
                            <button data-modal-hide="popup-modal" type="button" className="text-white bg-primary hover:shadow-lg focus:ring-4 focus:outline-none font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2 transition duration-300">
                                Yakin
                            </button>
