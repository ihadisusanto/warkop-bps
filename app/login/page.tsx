                ...
                <div className="bg-white mt-10 w-full lg:w-1/2 m-auto p-8">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="relative my-5 w-full lg:w-2/3 mx-auto">
                            ...
                            <input type="password" id="password" name="password" className="bg-gray-200 border-none text-secondaryBrown text-sm rounded-lg focus:ring-2 focus:ring-secondaryBrown focus:outline-none block w-full pl-10 p-2.5 transition duration-300" placeholder="Kata sandi"/>
                        </div>
                        <div className="relative my-5 w-full lg:w-2/3 mx-auto">
